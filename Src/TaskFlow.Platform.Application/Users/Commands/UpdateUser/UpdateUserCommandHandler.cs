    ...
    : IRequestHandler<UpdateUserCommand, UserDto>
{
    ...
    private async Task UpsertAddressAsync(User profile, UpdateUserAddressDto address, CancellationToken cancellationToken)
    {
        ...
        var existing = await addressRepository.GetForUpdateAsync(profile.AddressId.Value, cancellationToken)
                       ?? throw new ValidationFailedException([
